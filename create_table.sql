...
-- TPEx 每日收盤行情 (History)
-- =========================================================
CREATE TABLE IF NOT EXISTS TPEx_stock_history (
    trade_date DATE NOT NULL COMMENT '日期',
    stock_id VARCHAR(6) NOT NULL COMMENT '代碼',
    open_price DECIMAL(10,2) DEFAULT 0.00 COMMENT '開盤價',
    high_price DECIMAL(10,2) DEFAULT 0.00 COMMENT '最高價',
...
-- =========================================================
-- TPEx 三大法人買賣超 (Institutional Investors)
-- =========================================================
...
-- =========================================================
-- TPEx 融資融券 (Margin Trading)
-- =========================================================
CREATE TABLE IF NOT EXISTS TPEx_stock_margin (
    trade_date DATE NOT NULL COMMENT '日期',
    stock_id VARCHAR(6) NOT NULL COMMENT '代碼',
    margin_balance INT DEFAULT 0 COMMENT '融資今日餘額',
    margin_balance_diff INT DEFAULT 0 COMMENT '融資餘額增減',
...
-- TPEx 借券餘額 (SBL Total)
-- =========================================================
CREATE TABLE IF NOT EXISTS TPEx_stock_sbl_total (
    trade_date DATE NOT NULL COMMENT '日期',
    stock_id VARCHAR(6) NOT NULL COMMENT '代碼',
    sbl_balance INT DEFAULT 0 COMMENT '借券餘額',
...
-- =========================================================
-- TPEx 借券賣出餘額 (SBL Sold)
-- =========================================================
CREATE TABLE IF NOT EXISTS TPEx_stock_sbl_sold (
    trade_date DATE NOT NULL COMMENT '日期',
    stock_id VARCHAR(6) NOT NULL COMMENT '代碼',
    sbl_sold_balance INT DEFAULT 0 COMMENT '借券賣出餘額',
    sbl_sold INT DEFAULT 0 COMMENT '當日借券賣出',
...
CREATE TABLE market_daily (
    ...
    insti_total_buy DECIMAL(8,1) DEFAULT 0.0 COMMENT '三大法人買進金額(億元)',
    insti_total_sell DECIMAL(8,1) DEFAULT 0.0 COMMENT '三大法人賣出金額(億元)',
    insti_foreign_buy DECIMAL(8,1) DEFAULT 0.0 COMMENT '外資買進金額(億元)',
    insti_foreign_sell DECIMAL(8,1) DEFAULT 0.0 COMMENT '外資賣出金額(億元)',
    insti_trust_buy DECIMAL(8,1) DEFAULT 0.0 COMMENT '投信買進金額(億元)',
    insti_trust_sell DECIMAL(8,1) DEFAULT 0.0 COMMENT '投信賣出金額(億元)',
    insti_dealer_buy DECIMAL(8,1) DEFAULT 0.0 COMMENT '自營商買進金額(億元)',
    insti_dealer_sell DECIMAL(8,1) DEFAULT 0.0 COMMENT '自營商賣出金額(億元)',
    insti_dealer_risk_buy DECIMAL(8,1) DEFAULT 0.0 COMMENT '自營商避險買進金額(億元)',

...
if (count($dates_to_scrape) > 60) {
    $dates_to_scrape = array_slice($dates_to_scrape, -60);
}

echo json_encode($dates_to_scrape);exit;


// $postData = [
//     'type' => 'day',
//     'dayDate' => date('Ym01', time()),
//     'response' => 'json',
//     '_' => time(),
// ];

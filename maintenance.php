...
dbClean($pdo, 'TPEx_stock_history', 'trade_date', 110);
dbClean($pdo, 'TPEx_stock_insti', 'trade_date', 110);
dbClean($pdo, 'TPEx_stock_margin', 'trade_date', 110);
dbClean($pdo, 'TPEx_stock_sbl_total', 'trade_date', 110);
dbClean($pdo, 'TPEx_stock_sbl_sold', 'trade_date', 110);
dbClean($pdo, 'etf_component', 'trade_date', 110);
dbClean($pdo, 'stock_shareholder', 'trade_date', 110);
